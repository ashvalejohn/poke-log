...
const Splash = () => (
  <div className="splash-page">
    ...
    <Link to="/signup" className="splash-page__try-it">
      <span>Try It</span>
    </Link>
    <footer>
      <p>
        <a href="https://github.com/ashvalejohn/poke-log" target="_blank">
          Poke Log
        </a>{" "}
        was built by{" "}
        <a href="https://github.com/bucknermr" target="_blank">
          Matthew Buckner
        </a>,{" "}
        <a href="https://github.com/ashvalejohn" target="_blank">
          Ashley Johnson
        </a>{" "}
        and{" "}
        <a href="https://github.com/nwilliams770" target="_blank">
          Nicholas Williams
        </a>.
      </p>
    </footer>
